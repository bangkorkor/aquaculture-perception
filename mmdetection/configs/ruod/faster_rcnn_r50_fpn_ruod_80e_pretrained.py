_base_ = [
    ...
    './_base_/ruod_two_stage_schedule.py',
]
...
# Optional: detector-level COCO pretraining checkpoint.
# The MMDetection docs reference the checkpoint name
# `faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth`.
# Uncomment and set the exact URL/path you use locally if desired.
