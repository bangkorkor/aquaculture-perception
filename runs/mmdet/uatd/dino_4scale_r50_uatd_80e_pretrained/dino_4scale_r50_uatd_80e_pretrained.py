...
launcher = 'none'
load_from = '../runs/mmdet/uatd/dino_4scale_r50_uatd_80e_pretrained/best_coco_bbox_mAP_epoch_4.pth'
log_level = 'INFO'
...
work_dir = '../runs/mmdet/uatd/dino_4scale_r50_uatd_80e_pretrained'
