#!/usr/bin/env python3
"""
Detector + ByteTrack inference → MOT11 annotation export
=========================================================
...
LOG_INTERVAL = 100   # print progress every N frames
...
def main() -> None:
    ...
    for frame_idx, img_path in enumerate(image_paths, start=1):
        ...
        # Filename stem is the timestamp (nanoseconds), use it as frame ID
